            ...
            return function(editor) {
                ...
                var applyClass = function(classes, type) {
                    ...
                    if (type === "block") {
                        ...
                        var formatName = 'custom_block_' + classes.replace(/\s+/g, '_');
                        ...
                        var formatName = 'custom_inline_' + classes.replace(/\s+/g, '_');
                        editor.formatter.register(formatName, {
                            inline: "span",
                            classes: classes,
                        });
                ...
                var clearAllClasses = function() {
                    ...
                    jsonDef.forEach(function(styleDef) {
                        if (styleDef.type === "inline" && styleDef.classes) {
                            var formatName = 'custom_inline_' + styleDef.classes.replace(/\s+/g, '_');
                ...
                var buildMenuItems = function() {
                    ...
                    var styleItems = jsonDef.map(function(styleDef) {
                        return {
                            ...
                            onSetup: function() {
                                setTimeout(function() {
                                    var menuItems = document.querySelectorAll('.tox-menu .tox-collection__item');
